...
MainFolder="MM/LUT_2PH_TET4_EXP_Adapt_Ref_Add_Ref_V13" # folder where all the data are saved
PlotFolder="CompPlot_2PH_TET4_EXP_Adapt_Ref_Add_Ref_V13" # Folder where the fluid data plots are saved
PlotFolderLuT="CompLuT_2PH_TET4_EXP_Adapt_Ref_Add_Ref_V13" # Folder where the LUT plots are saved
outpath="LUT_2PH_TET4_EXP_Adapt_Ref_Add_Ref_V13.vtk" # Name of the file where the LuT are saved to be opened by Paraview
LuTName="LUT_2PH_TET4_EXP_Adapt_Ref_Add_Ref_V13.drg"      # # Name of the file where the LuT are saved as .drg
